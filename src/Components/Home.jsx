        ...
        <div name="Home" className=" md:flex py-[70px]">
          <div className="left px-14 py-12 md:w-[60%]">
            ...
            <p className="text-justify py-1 leading-5">
              I am a dedicated frontend web developer with a passion for
              crafting seamless and interactive web experiences. With expertise
              in various modern web technologies, I aim to deliver high-quality,
